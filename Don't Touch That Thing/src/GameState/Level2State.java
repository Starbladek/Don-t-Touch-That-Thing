...
public class Level2State extends GameState {
	...
	private int scoreBallSpawnTimerLength = 900;
	
	private int timeToLeaveAt = 240;
	...
	public Level2State(GameStateManager gsm) {
		...
		try {
			...
			bg = new Background(Content.Level2BG);
			bg.setVelocity(0, 0);
			bg.setPosition(0, 0);
	...
	public void init() {
		...
		thing = new Thing(players, scoreBalls, 0.75);
	...
	public void update() {
		...
		if (GameStateManager.timeLeft < timeToLeaveAt)
			gsm.wipeTransitionState(GameStateManager.LEVEL3STATE);
