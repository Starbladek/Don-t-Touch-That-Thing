...
public class Level1State extends GameState {
	...
	private int powerUpSpawnTimerLength = 20000;
	
	private long scoreBallSpawnTimer;
	private long scoreBallElapsed;
	private int scoreBallSpawnTimerLength = 1000;
	
	private int timeToLeaveAt = 300;
	...
	public Level1State(GameStateManager gsm) {
		...
		try {
			...
			bg = new Background(Content.Level1BG);
			bg.setVelocity(0, 0);
			bg.setPosition(0, 0);
	...
	public void init() {
		...
		thing = new Thing(players, scoreBalls, 0.7);
	...
	public void update() {
		...
		if (GameStateManager.timeLeft < timeToLeaveAt)
			gsm.wipeTransitionState(GameStateManager.LEVEL2STATE);
